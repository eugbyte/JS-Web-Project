...
function calcTime(wordArray, id) {
  ...
  var converter = Math.round*((1/130) * accumulator) || 1; //assuming words in a 1 minute speech consists of 130 words
  //the operator ensures that if Math.round returns 0, which coerces to false, the reading time will be set to 1 min.
document.getElementById(id).innerHTML = "Average reading time: " + converter + " min"; //now need to print the words back into the page
}
